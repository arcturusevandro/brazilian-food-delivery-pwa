...
drop policy if exists "business_hours_owner_delete" on public.business_hours;
...
drop policy if exists "combos_owner_insert" on public.combos;
drop policy if exists "combos_owner_update" on public.combos;
drop policy if exists "combos_owner_delete" on public.combos;
drop policy if exists "delivery_settings_owner_insert" on public.delivery_settings;
drop policy if exists "delivery_settings_owner_update" on public.delivery_settings;
drop policy if exists "delivery_settings_owner_delete" on public.delivery_settings;
drop policy if exists "delivery_zones_owner_insert" on public.delivery_zones;
drop policy if exists "delivery_zones_owner_update" on public.delivery_zones;
drop policy if exists "delivery_zones_owner_delete" on public.delivery_zones;
drop policy if exists "products_owner_insert" on public.products;
drop policy if exists "products_owner_update" on public.products;
drop policy if exists "products_owner_delete" on public.products;
drop policy if exists "combo_items_owner_insert" on public.combo_items;
drop policy if exists "combo_items_owner_update" on public.combo_items;
drop policy if exists "combo_items_owner_delete" on public.combo_items;
drop policy if exists "product_addons_owner_insert" on public.product_addons;
drop policy if exists "product_addons_owner_update" on public.product_addons;
drop policy if exists "product_addons_owner_delete" on public.product_addons;
drop policy if exists "Permanent owner can upload product images" on storage.objects;
drop policy if exists "Permanent owner can delete product images" on storage.objects;
...
create policy "business_hours_owner_insert" on public.business_hours
  ...
  with check (coalesce(((select auth.jwt()) ->> 'is_anonymous')::boolean, false) is false and owns_restaurant(restaurant_id));
create policy "business_hours_owner_update" on public.business_hours
  for update to authenticated
  using (coalesce(((select auth.jwt()) ->> 'is_anonymous')::boolean, false) is false and owns_restaurant(restaurant_id))
  with check (coalesce(((select auth.jwt()) ->> 'is_anonymous')::boolean, false) is false and owns_restaurant(restaurant_id));
...
create policy "restaurants_owner_insert" on public.restaurants
  for insert to authenticated
  with check (coalesce(((select auth.jwt()) ->> 'is_anonymous')::boolean, false) is false and owner_id = (select auth.uid()));
...
create policy "restaurants_owner_update" on public.restaurants
  for update to authenticated
  using (coalesce(((select auth.jwt()) ->> 'is_anonymous')::boolean, false) is false and owner_id = (select auth.uid()))
  with check (coalesce(((select auth.jwt()) ->> 'is_anonymous')::boolean, false) is false and owner_id = (select auth.uid()));
